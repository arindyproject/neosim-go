...
func (h *RBACHandler) ListPermissions(c *echo.Context) error {
	...
	items, total, err := h.service.ListPermissions(c.Request().Context(), page, pageSize)
	if err != nil {
...
func (h *RBACHandler) GetPermission(c *echo.Context) error {
	...
	item, err := h.service.GetPermissionByID(c.Request().Context(), id)
	if err != nil {
...
func (h *RBACHandler) CreatePermission(c *echo.Context) error {
	...
	item, err := h.service.CreatePermission(c.Request().Context(), &req, he.GetActorID(c))
	if err != nil {
...
func (h *RBACHandler) UpdatePermission(c *echo.Context) error {
	...
	item, err := h.service.UpdatePermission(c.Request().Context(), id, &req, he.GetActorID(c))
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) ListRoles(c *echo.Context) error {
	...
	items, total, err := h.service.ListRoles(c.Request().Context(), page, pageSize)
	if err != nil {
...
func (h *RBACHandler) GetRole(c *echo.Context) error {
	...
	item, err := h.service.GetRoleByID(c.Request().Context(), id)
	if err != nil {
		return response.Response(c, http.StatusNotFound, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) CreateRole(c *echo.Context) error {
	...
	item, err := h.service.CreateRole(c.Request().Context(), &req, he.GetActorID(c))
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) UpdateRole(c *echo.Context) error {
	...
	item, err := h.service.UpdateRole(c.Request().Context(), id, &req, he.GetActorID(c))
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) AssignPermissionsToRole(c *echo.Context) error {
	...
	if err := h.service.AssignPermissionsToRole(c.Request().Context(), id, &req); err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) SyncRolePermissions(c *echo.Context) error {
	...
	if err := h.service.SyncRolePermissions(c.Request().Context(), id, &req); err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) RevokePermissionsFromRole(c *echo.Context) error {
	...
	if err := h.service.RevokePermissionsFromRole(c.Request().Context(), id, &req); err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) AssignRolesToUser(c *echo.Context) error {
	...
	if err := h.service.AssignRolesToUser(c.Request().Context(), userID, &req, he.GetActorID(c)); err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) SyncUserRoles(c *echo.Context) error {
	...
	if err := h.service.SyncUserRoles(c.Request().Context(), userID, &req, he.GetActorID(c)); err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) RevokeRolesFromUser(c *echo.Context) error {
	...
	if err := h.service.RevokeRolesFromUser(c.Request().Context(), userID, &req); err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
...
func (h *RBACHandler) GetUserAllPermissions(c *echo.Context) error {
	...
	perms, err := h.service.GetUserAllPermissions(c.Request().Context(), userID)
	if err != nil {
...
func (h *RBACHandler) AssignDirectPermission(c *echo.Context) error {
	...
	if err := h.service.AssignDirectPermission(c.Request().Context(), userID, &req, he.GetActorID(c)); err != nil {
		return response.Response(c, http.StatusBadRequest, false, err.Error(), nil, nil)
	}
