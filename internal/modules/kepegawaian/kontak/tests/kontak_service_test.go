...
func (s *KepegawaianKontakServiceTestSuite) SetupTest() {
	...
	s.svc = services.NewKepegawaianKontakService(s.repo, s.rbacRepo, s.authRepo)
}
...
func (s *KepegawaianKontakServiceTestSuite) Test_Create_Superadmin_Success() {
	req := &dto.CreateKepegawaianKontakRequest{Name: "Test KepegawaianKontak"}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.KepegawaianKontak")).Return(nil)
...
func (s *KepegawaianKontakServiceTestSuite) Test_Create_WithPermission_Success() {
	req := &dto.CreateKepegawaianKontakRequest{Name: "Test KepegawaianKontak"}
	actor := regularActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_Create_WithManagePermission_Success() {
...
func (s *KepegawaianKontakServiceTestSuite) Test_Create_Forbidden() {
	req := &dto.CreateKepegawaianKontakRequest{Name: "Test"}
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianKontakServiceTestSuite) Test_Create_RepoError() {
	req := &dto.CreateKepegawaianKontakRequest{Name: "Test"}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.KepegawaianKontak")).Return(fmt.Errorf("db error"))
...
func (s *KepegawaianKontakServiceTestSuite) Test_GetByID_Superadmin_Success() {
	actor := superadminActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_GetByID_WithPermission_Success() {
	actor := regularActor()
	item := factories.NewKepegawaianKontakFactory().Make()
	item.ID = 1
...
func (s *KepegawaianKontakServiceTestSuite) Test_GetByID_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianKontakServiceTestSuite) Test_GetByID_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_GetByID_RepoError() {
	actor := superadminActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_List_Superadmin_Success() {
	actor := superadminActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_List_WithPermission_Success() {
	actor := regularActor()
	filter := &dto.FilterKepegawaianKontakRequest{}
...
func (s *KepegawaianKontakServiceTestSuite) Test_List_Forbidden() {
	actor := regularActor()
	filter := &dto.FilterKepegawaianKontakRequest{}
	s.mockNoPermissions()
...
func (s *KepegawaianKontakServiceTestSuite) Test_List_DefaultPagination() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianKontakRequest{}

	s.repo.On("List", 1, 10, filter).Return([]models.KepegawaianKontak{}, int64(0), nil)
...
func (s *KepegawaianKontakServiceTestSuite) Test_List_PageSizeCapped() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianKontakRequest{}
...
func (s *KepegawaianKontakServiceTestSuite) Test_List_WithNameFilter() {
	actor := superadminActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_Update_Superadmin_Success() {
	actor := superadminActor()
	...
	s.repo.On("Update", mock.AnythingOfType("*models.KepegawaianKontak")).Return(nil)
...
func (s *KepegawaianKontakServiceTestSuite) Test_Update_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewKepegawaianKontakFactory().Make()
	existing.ID = 1
	newName := "Updated"
...
func (s *KepegawaianKontakServiceTestSuite) Test_Update_Forbidden() {
	actor := regularActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_Update_NotFound() {
	actor := superadminActor()
	req := &dto.UpdateKepegawaianKontakRequest{}
...
func (s *KepegawaianKontakServiceTestSuite) Test_Update_PartialFields() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKontakFactory().Make()
	existing.ID = 1
	...
	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.MatchedBy(func(m *models.KepegawaianKontak) bool {
...
func (s *KepegawaianKontakServiceTestSuite) Test_Update_RepoError() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKontakFactory().Make()
	existing.ID = 1
	req := &dto.UpdateKepegawaianKontakRequest{}
	...
	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.AnythingOfType("*models.KepegawaianKontak")).Return(fmt.Errorf("db error"))
...
func (s *KepegawaianKontakServiceTestSuite) Test_Delete_Superadmin_Success() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKontakFactory().Make()
	existing.ID = 1
...
func (s *KepegawaianKontakServiceTestSuite) Test_Delete_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewKepegawaianKontakFactory().Make()
	existing.ID = 1
...
func (s *KepegawaianKontakServiceTestSuite) Test_Delete_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianKontakServiceTestSuite) Test_Delete_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianKontakServiceTestSuite) Test_Delete_RepoError() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKontakFactory().Make()
	existing.ID = 1
