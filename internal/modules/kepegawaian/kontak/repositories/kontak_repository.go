...
func (r *repository) Create(m *models.KepegawaianKontak) error {
	return r.db.Create(m).Error
}

func (r *repository) GetByID(id int64) (*models.KepegawaianKontak, error) {
...
func (r *repository) List(page, pageSize int, filter *dto.FilterKepegawaianKontakRequest) ([]models.KepegawaianKontak, int64, error) {
...
func (r *repository) Update(m *models.KepegawaianKontak) error {
