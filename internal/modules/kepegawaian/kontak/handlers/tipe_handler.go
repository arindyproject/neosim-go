...
// Method di bawah ini ditempelkan ke struct KepegawaianKontakHandler yang
...
//	@Router			/kepegawaian/kontak/tipes [get]
func (h *KepegawaianKontakHandler) ListTipe(c *echo.Context) error {
...
//	@Success		200	{object}	response.MyGoResponse{data=dto.TipeResponse}
//	@Router			/kepegawaian/kontak/tipes/{id} [get]
func (h *KepegawaianKontakHandler) GetTipeByID(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
...
//	@Router			/kepegawaian/kontak/tipes [post]
func (h *KepegawaianKontakHandler) CreateTipe(c *echo.Context) error {
...
//	@Success		200		{object}	response.MyGoResponse{data=dto.TipeResponse}
//	@Router			/kepegawaian/kontak/tipes/{id} [put]
func (h *KepegawaianKontakHandler) UpdateTipe(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, "ID tidak valid", nil, nil)
	}
...
//	@Router			/kepegawaian/kontak/tipes/{id} [delete]
func (h *KepegawaianKontakHandler) DeleteTipe(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, "ID tidak valid", nil, nil)
	}
