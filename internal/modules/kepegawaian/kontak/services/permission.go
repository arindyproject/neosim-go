...
func (s *service) canReadKepegawaianKontak(actor he.AuthContext) (bool, error) {
...
func (s *service) canCreateKepegawaianKontak(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canUpdateKepegawaianKontak(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canDeleteKepegawaianKontak(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
