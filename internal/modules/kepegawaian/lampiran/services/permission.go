...
func (s *service) canReadKepegawaianLampiran(actor he.AuthContext) (bool, error) {
...
func (s *service) canCreateKepegawaianLampiran(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canUpdateKepegawaianLampiran(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canDeleteKepegawaianLampiran(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
