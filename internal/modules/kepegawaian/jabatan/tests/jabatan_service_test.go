...
func (s *KepegawaianJabatanServiceTestSuite) SetupTest() {
	...
	s.svc = services.NewKepegawaianJabatanService(s.repo, s.rbacRepo, s.authRepo, s.userRepo, s.cfg)
...
func (s *KepegawaianJabatanServiceTestSuite) Test_ListJabatan_WithNameFilter() {
	actor := superadminActor()
