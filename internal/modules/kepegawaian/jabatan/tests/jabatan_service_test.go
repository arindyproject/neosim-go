...
func (s *KepegawaianJabatanServiceTestSuite) SetupTest() {
	...
	s.svc = services.NewKepegawaianJabatanService(s.repo, s.rbacRepo, s.authRepo)
}
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Create_Superadmin_Success() {
	req := &dto.CreateKepegawaianJabatanRequest{Name: "Test KepegawaianJabatan"}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.KepegawaianJabatan")).Return(nil)
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Create_WithPermission_Success() {
	req := &dto.CreateKepegawaianJabatanRequest{Name: "Test KepegawaianJabatan"}
	actor := regularActor()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Create_WithManagePermission_Success() {
	req := &dto.CreateKepegawaianJabatanRequest{Name: "Test"}
	actor := regularActor()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Create_Forbidden() {
	req := &dto.CreateKepegawaianJabatanRequest{Name: "Test"}
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Create_RepoError() {
	req := &dto.CreateKepegawaianJabatanRequest{Name: "Test"}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.KepegawaianJabatan")).Return(fmt.Errorf("db error"))
...
func (s *KepegawaianJabatanServiceTestSuite) Test_GetByID_Superadmin_Success() {
	actor := superadminActor()
	item := factories.NewKepegawaianJabatanFactory().Make()
	item.ID = 1
...
func (s *KepegawaianJabatanServiceTestSuite) Test_GetByID_WithPermission_Success() {
	actor := regularActor()
	item := factories.NewKepegawaianJabatanFactory().Make()
	item.ID = 1
...
func (s *KepegawaianJabatanServiceTestSuite) Test_GetByID_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_GetByID_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_GetByID_RepoError() {
	actor := superadminActor()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_List_Superadmin_Success() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianJabatanRequest{}
	items := []models.KepegawaianJabatan{
		*factories.NewKepegawaianJabatanFactory().Make(),
		*factories.NewKepegawaianJabatanFactory().Make(),
	}
...
func (s *KepegawaianJabatanServiceTestSuite) Test_List_WithPermission_Success() {
	actor := regularActor()
	filter := &dto.FilterKepegawaianJabatanRequest{}
	items := []models.KepegawaianJabatan{*factories.NewKepegawaianJabatanFactory().Make()}
...
func (s *KepegawaianJabatanServiceTestSuite) Test_List_Forbidden() {
	actor := regularActor()
	filter := &dto.FilterKepegawaianJabatanRequest{}
	s.mockNoPermissions()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_List_DefaultPagination() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianJabatanRequest{}

	s.repo.On("List", 1, 10, filter).Return([]models.KepegawaianJabatan{}, int64(0), nil)
...
func (s *KepegawaianJabatanServiceTestSuite) Test_List_PageSizeCapped() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianJabatanRequest{}
...
func (s *KepegawaianJabatanServiceTestSuite) Test_List_WithNameFilter() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianJabatanRequest{Name: "test"}
	items := []models.KepegawaianJabatan{*factories.NewKepegawaianJabatanFactory().Make()}
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Update_Superadmin_Success() {
	actor := superadminActor()
	existing := factories.NewKepegawaianJabatanFactory().Make()
	existing.ID = 1
	newName := "Updated Name"
	req := &dto.UpdateKepegawaianJabatanRequest{Name: &newName}

	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.AnythingOfType("*models.KepegawaianJabatan")).Return(nil)
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Update_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewKepegawaianJabatanFactory().Make()
	existing.ID = 1
	newName := "Updated"
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Update_Forbidden() {
	actor := regularActor()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Update_NotFound() {
	actor := superadminActor()
	req := &dto.UpdateKepegawaianJabatanRequest{}
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Update_PartialFields() {
	actor := superadminActor()
	existing := factories.NewKepegawaianJabatanFactory().Make()
	existing.ID = 1
	originalName := existing.Name
	newDesc := "New description"
	req := &dto.UpdateKepegawaianJabatanRequest{Description: &newDesc}

	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.MatchedBy(func(m *models.KepegawaianJabatan) bool {
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Update_RepoError() {
	actor := superadminActor()
	existing := factories.NewKepegawaianJabatanFactory().Make()
	existing.ID = 1
	req := &dto.UpdateKepegawaianJabatanRequest{}
	...
	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.AnythingOfType("*models.KepegawaianJabatan")).Return(fmt.Errorf("db error"))
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Delete_Superadmin_Success() {
	actor := superadminActor()
	existing := factories.NewKepegawaianJabatanFactory().Make()
	existing.ID = 1
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Delete_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewKepegawaianJabatanFactory().Make()
	existing.ID = 1
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Delete_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Delete_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianJabatanServiceTestSuite) Test_Delete_RepoError() {
	actor := superadminActor()
	existing := factories.NewKepegawaianJabatanFactory().Make()
	existing.ID = 1
