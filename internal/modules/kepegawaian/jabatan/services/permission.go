...
func (s *service) canReadKepegawaianJabatan(actor he.AuthContext) (bool, error) {
...
func (s *service) canCreateKepegawaianJabatan(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canUpdateKepegawaianJabatan(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canDeleteKepegawaianJabatan(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
