...
// ── CanRead ───────────────────────────────────────────────────────────────────
func (s *service) canReadJobTitle(ctx context.Context,actor he.AuthContext) (bool, error) {
...
// ── canCreate ─────────────────────────────────────────────────────────────────
func (s *service) canCreateJobTitle(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canUpdate ─────────────────────────────────────────────────────────────────
func (s *service) canUpdateJobTitle(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canDelete ─────────────────────────────────────────────────────────────────
func (s *service) canDeleteJobTitle(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
