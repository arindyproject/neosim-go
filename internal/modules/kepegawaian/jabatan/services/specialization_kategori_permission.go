...
// ── CanRead ───────────────────────────────────────────────────────────────────
func (s *service) canReadSpecializationKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
...
// ── canCreate ─────────────────────────────────────────────────────────────────
func (s *service) canCreateSpecializationKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canUpdate ─────────────────────────────────────────────────────────────────
func (s *service) canUpdateSpecializationKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canDelete ─────────────────────────────────────────────────────────────────
func (s *service) canDeleteSpecializationKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
