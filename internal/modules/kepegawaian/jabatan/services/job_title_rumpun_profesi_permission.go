...
// ── CanRead ───────────────────────────────────────────────────────────────────
func (s *service) canReadJobTitleRumpunProfesi(ctx context.Context,actor he.AuthContext) (bool, error) {
...
// ── canCreate ─────────────────────────────────────────────────────────────────
func (s *service) canCreateJobTitleRumpunProfesi(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canUpdate ─────────────────────────────────────────────────────────────────
func (s *service) canUpdateJobTitleRumpunProfesi(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canDelete ─────────────────────────────────────────────────────────────────
func (s *service) canDeleteJobTitleRumpunProfesi(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
