...
// ── CanRead ───────────────────────────────────────────────────────────────────
func (s *service) canReadPositionKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
...
// ── canCreate ─────────────────────────────────────────────────────────────────
func (s *service) canCreatePositionKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canUpdate ─────────────────────────────────────────────────────────────────
func (s *service) canUpdatePositionKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
// ── canDelete ─────────────────────────────────────────────────────────────────
func (s *service) canDeletePositionKategori(ctx context.Context,actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
