...
// JobTitleRumpunProfesi represents the kepegawaian_jabatan_job_title_rumpun_profesis table in database
type JobTitleRumpunProfesi struct {
...
func (JobTitleRumpunProfesi) TableName() string {
	return "kepegawaian_jabatan_job_title_rumpun_profesis"
}
