...
// JobTitleKategori represents the kepegawaian_jabatan_job_title_kategoris table in database
type JobTitleKategori struct {
...
func (JobTitleKategori) TableName() string {
	return "kepegawaian_jabatan_job_title_kategoris"
}
