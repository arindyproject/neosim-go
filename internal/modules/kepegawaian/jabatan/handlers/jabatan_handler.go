...
//	@Router			/api/v1/kepegawaian/jabatan [get]
func (h *KepegawaianJabatanHandler) List(c *echo.Context) error {
	page, pageSize := 1, 10
...
//	@Success		200	{object}	response.MyGoResponse{data=dto.KepegawaianJabatanResponse}
//	@Router			/api/v1/kepegawaian/jabatan/{id} [get]
func (h *KepegawaianJabatanHandler) GetByID(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
...
//	@Router			/api/v1/kepegawaian/jabatan [post]
func (h *KepegawaianJabatanHandler) Create(c *echo.Context) error {
...
//	@Success		200		{object}	response.MyGoResponse{data=dto.KepegawaianJabatanResponse}
//	@Router			/api/v1/kepegawaian/jabatan/{id} [put]
func (h *KepegawaianJabatanHandler) Update(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, "ID tidak valid", nil, nil)
	}
...
//	@Router			/api/v1/kepegawaian/jabatan/{id} [delete]
func (h *KepegawaianJabatanHandler) Delete(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, "ID tidak valid", nil, nil)
	}
