...
// Catatan: suite KepegawaianAlamatServiceTestSuite, TestMain, dan helper
// (superadminActor, regularActor, mockNoPermissions, dst) sudah didefinisikan
// di alamat_service_test.go. File ini HANYA menambah skenario test untuk
...
func (s *KepegawaianAlamatServiceTestSuite) Test_GetTipeByID_Success() {
	actor := superadminActor()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_GetTipeByID_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_GetTipeByID_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_ListTipe_Success() {
	actor := superadminActor()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_ListTipe_Forbidden() {
	actor := regularActor()
	filter := &dto.FilterTipeRequest{}
	s.mockNoPermissions()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_UpdateTipe_Success() {
	actor := superadminActor()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_UpdateTipe_Forbidden() {
	actor := regularActor()
	req := &dto.UpdateTipeRequest{}
	s.mockNoPermissions()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_DeleteTipe_Success() {
	actor := superadminActor()
	existing := factories.NewTipeFactory().Make()
	existing.ID = 1
...
func (s *KepegawaianAlamatServiceTestSuite) Test_DeleteTipe_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianAlamatServiceTestSuite) Test_DeleteTipe_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
