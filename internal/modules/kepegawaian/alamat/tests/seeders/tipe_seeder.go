...
func (s *TipeSeeder) Run() error {
	log.Println("🌱 Seeding kepegawaian_alamat_tipes...")
	...
	log.Println("✅ kepegawaian_alamat_tipes seeding selesai!")
	return nil
}

func (s *TipeSeeder) Fresh() error {
	log.Println("🗑️  Menghapus semua data kepegawaian_alamat_tipes...")
	if err := s.db.Exec("DELETE FROM kepegawaian_alamat_tipes").Error; err != nil {
		return err
	}
	if err := s.db.Exec("ALTER SEQUENCE kepegawaian_alamat_tipes_id_seq RESTART WITH 1").Error; err != nil {
