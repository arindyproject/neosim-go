...
func (m *KepegawaianAlamatRepositoryMock) GetTipeByCode(ctx context.Context, code string) (*models.Tipe, error) {
	args := m.Called(code)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *KepegawaianAlamatRepositoryMock) GetTipeByLabel(ctx context.Context, label string) (*models.Tipe, error) {
	args := m.Called(label)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *KepegawaianAlamatRepositoryMock) ListSelectTipe(ctx context.Context, search string) ([]models.Tipe, error) {
