...
// Method di bawah ini ditempelkan ke struct KepegawaianAlamatHandler yang
...
//	@Success		200	{object}	response.MyGoResponse{data=dto.TipeResponse}
//	@Router			/kepegawaian/alamat/tipes/{id} [get]
func (h *KepegawaianAlamatHandler) GetTipeByID(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
...
//	@Router			/kepegawaian/alamat/tipes [post]
func (h *KepegawaianAlamatHandler) CreateTipe(c *echo.Context) error {
...
//	@Success		200		{object}	response.MyGoResponse{data=dto.TipeResponse}
//	@Router			/kepegawaian/alamat/tipes/{id} [put]
func (h *KepegawaianAlamatHandler) UpdateTipe(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, "ID tidak valid", nil, nil)
	}
...
//	@Router			/kepegawaian/alamat/tipes/{id} [delete]
func (h *KepegawaianAlamatHandler) DeleteTipe(c *echo.Context) error {
	id, err := he.ParseID(c)
	if err != nil {
		return response.Response(c, http.StatusBadRequest, false, "ID tidak valid", nil, nil)
	}
