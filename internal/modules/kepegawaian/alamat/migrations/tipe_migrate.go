...
//go:embed 20260910111246_create_kepegawaian_alamat_tipes_table.sql
var tipeSQL string
...
func MigrateTipeWithSQL(sqlDB *sql.DB) error {
	...
	if err != nil {
		log.Printf("Error creating kepegawaian_alamat_tipes table: %v", err)
		return err
	}
	log.Println("kepegawaian_alamat_tipes table migrated successfully")
	return nil
}
