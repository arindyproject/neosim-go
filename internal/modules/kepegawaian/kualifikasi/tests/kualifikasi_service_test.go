...
func (s *KepegawaianKualifikasiServiceTestSuite) SetupTest() {
	...
	s.svc = services.NewKepegawaianKualifikasiService(s.repo, s.rbacRepo, s.authRepo)
}
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Create_Superadmin_Success() {
	req := &dto.CreateKepegawaianKualifikasiRequest{Name: "Test KepegawaianKualifikasi"}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.KepegawaianKualifikasi")).Return(nil)
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Create_WithPermission_Success() {
	req := &dto.CreateKepegawaianKualifikasiRequest{Name: "Test KepegawaianKualifikasi"}
	actor := regularActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Create_WithManagePermission_Success() {
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Create_Forbidden() {
	req := &dto.CreateKepegawaianKualifikasiRequest{Name: "Test"}
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Create_RepoError() {
	req := &dto.CreateKepegawaianKualifikasiRequest{Name: "Test"}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.KepegawaianKualifikasi")).Return(fmt.Errorf("db error"))
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_GetByID_Superadmin_Success() {
	actor := superadminActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_GetByID_WithPermission_Success() {
	actor := regularActor()
	item := factories.NewKepegawaianKualifikasiFactory().Make()
	item.ID = 1
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_GetByID_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_GetByID_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_GetByID_RepoError() {
	actor := superadminActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_List_Superadmin_Success() {
	actor := superadminActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_List_WithPermission_Success() {
	actor := regularActor()
	filter := &dto.FilterKepegawaianKualifikasiRequest{}
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_List_Forbidden() {
	actor := regularActor()
	filter := &dto.FilterKepegawaianKualifikasiRequest{}
	s.mockNoPermissions()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_List_DefaultPagination() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianKualifikasiRequest{}

	s.repo.On("List", 1, 10, filter).Return([]models.KepegawaianKualifikasi{}, int64(0), nil)
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_List_PageSizeCapped() {
	actor := superadminActor()
	filter := &dto.FilterKepegawaianKualifikasiRequest{}
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_List_WithNameFilter() {
	actor := superadminActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Update_Superadmin_Success() {
	actor := superadminActor()
	...
	s.repo.On("Update", mock.AnythingOfType("*models.KepegawaianKualifikasi")).Return(nil)
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Update_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewKepegawaianKualifikasiFactory().Make()
	existing.ID = 1
	newName := "Updated"
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Update_Forbidden() {
	actor := regularActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Update_NotFound() {
	actor := superadminActor()
	req := &dto.UpdateKepegawaianKualifikasiRequest{}
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Update_PartialFields() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKualifikasiFactory().Make()
	existing.ID = 1
	...
	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.MatchedBy(func(m *models.KepegawaianKualifikasi) bool {
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Update_RepoError() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKualifikasiFactory().Make()
	existing.ID = 1
	req := &dto.UpdateKepegawaianKualifikasiRequest{}
	...
	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.AnythingOfType("*models.KepegawaianKualifikasi")).Return(fmt.Errorf("db error"))
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Delete_Superadmin_Success() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKualifikasiFactory().Make()
	existing.ID = 1
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Delete_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewKepegawaianKualifikasiFactory().Make()
	existing.ID = 1
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Delete_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Delete_NotFound() {
	actor := superadminActor()
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_Delete_RepoError() {
	actor := superadminActor()
	existing := factories.NewKepegawaianKualifikasiFactory().Make()
	existing.ID = 1
