...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_ListSelectTipe_Success() {
	actor := superadminActor()
	search := "NIK"
	items := []models.Tipe{
		*factories.NewTipeFactory().Make(),
...
// not found
func (s *KepegawaianKualifikasiServiceTestSuite) Test_ListSelectTipe_NotFound() {
...
func (s *KepegawaianKualifikasiServiceTestSuite) Test_ListSelectTipe_RepoError() {
	actor := superadminActor()
