...
//go:embed 20260830210729_create_kepegawaian_kualifikasi_tipes_table.sql
var tipeSQL string
...
func MigrateTipeWithSQL(sqlDB *sql.DB) error {
	...
	if err != nil {
		log.Printf("Error creating kepegawaian_kualifikasi_tipes table: %v", err)
		return err
	}
	log.Println("kepegawaian_kualifikasi_tipes table migrated successfully")
	return nil
}
