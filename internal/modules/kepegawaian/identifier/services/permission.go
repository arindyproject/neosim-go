...
func (s *service) canReadKepegawaianIdentifier(actor he.AuthContext) (bool, error) {
...
func (s *service) canUpdateKepegawaianIdentifier(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canDeleteKepegawaianIdentifier(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
