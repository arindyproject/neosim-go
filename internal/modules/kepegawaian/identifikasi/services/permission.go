...
func (s *service) canReadKepegawaianIdentifikasi(actor he.AuthContext) (bool, error) {
...
func (s *service) canCreateKepegawaianIdentifikasi(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canUpdateKepegawaianIdentifikasi(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canDeleteKepegawaianIdentifikasi(actor he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
