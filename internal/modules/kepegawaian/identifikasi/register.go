...
import (
	...
	"neosim_go/internal/modules/kepegawaian/identifikasi/migrations"
...
func (r *registryModule) Models() []interface{} {
	return []interface{}{
		&models.KepegawaianIdentifikasi{},
	}
}
...
func (r *registryModule) MigrateSQL(sqlDB *sql.DB) error {
	return migrations.MigrateKepegawaianIdentifikasiWithSQL(sqlDB)
}
