...
type service struct {
	repo     pendidikanContracts.Repository
...
// NewKepegawaianPendidikanService membuat instance service baru
func NewKepegawaianPendidikanService(
	repo pendidikanContracts.Repository,
	rbacRepo rbacContracts.RBACRepository,
	authRepo authContracts.AuthRepository,
	userRepo userContracts.Repository,
	cfg    *config.Config,
) pendidikanContracts.Service {
	return &service{
		repo:     repo,
		rbacRepo: rbacRepo,
		authRepo: authRepo,
...
func (s *service) buildAuditMaps(ctx context.Context,items []models.KepegawaianPendidikan) (map[int64]*he.UserData, map[int64]*he.UserData) {
