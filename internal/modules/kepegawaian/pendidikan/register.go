...
import (
	...
	"neosim_go/internal/modules/kepegawaian/pendidikan/migrations"
...
func (r *registryModule) MigrateSQL(sqlDB *sql.DB) error {
	if err := migrations.MigrateKepegawaianPendidikanWithSQL(sqlDB); err != nil {
		return err
	}
	if err := migrations.MigrateJenjangWithSQL(sqlDB); err != nil {
		return err
	}
	// GEN:ITEM_MIGRATIONS
	return nil
