...
import (
	...
	"neosim_go/internal/modules/artikel/handlers"
	"neosim_go/internal/modules/artikel/repositories"
	"neosim_go/internal/modules/artikel/services"
...
// Module mewakili artikel module
type Module struct {
	db         *gorm.DB
...
func NewModule(
	...
	svc := services.NewArtikelService(
		repo,
		rbacRepo,
		authRepo,
	)
	handler := handlers.NewArtikelHandler(svc)
