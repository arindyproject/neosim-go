...
type ArtikelKategoriRepository interface {
	CreateKategori(ctx context.Context,m *models.ArtikelKategori) error
...
type ArtikelKategoriService interface {
	CreateKategori(ctx context.Context,req *dto.CreateArtikelKategoriRequest, actor he.AuthContext) (*dto.ArtikelKategoriResponse, error)
	GetKategoriByID(ctx context.Context,id int64, actor he.AuthContext) (*dto.ArtikelKategoriResponse, error)
	ListKategori(ctx context.Context,page, pageSize int, filter *dto.FilterArtikelKategoriRequest, actor he.AuthContext) ([]dto.ArtikelKategoriResponse, int64, error)
	UpdateKategori(ctx context.Context,id int64, req *dto.UpdateArtikelKategoriRequest, actor he.AuthContext) (*dto.ArtikelKategoriResponse, error)
	DeleteKategori(ctx context.Context,id int64, actor he.AuthContext) error
}
