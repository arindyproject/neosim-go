...
// ─── Permission ─────────────────────────────────────────────────────────────────
func (s *service) canReadArtikelKetegori(actor  he.AuthContext) (bool, error) {
...
func (s *service) canCreateArtikelKetegori(actor  he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canUpdateArtikelKetegori(actor  he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
...
func (s *service) canDeleteArtikelKetegori(actor  he.AuthContext) (bool, error) {
	if actor.IsSuperadmin {
		return true, nil
	}
