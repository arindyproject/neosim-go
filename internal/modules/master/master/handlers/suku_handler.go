...
func (h *MasterHandler) ListSuku(c *echo.Context) error {
	...
	items, total, err := h.service.ListSuku(c.Request().Context(), page, pageSize, &filter)
	if err != nil {
...
func (h *MasterHandler) GetByIDSuku(c *echo.Context) error {
	...
	item, err := h.service.GetByIDSuku(c.Request().Context(), id)
	if err != nil {
...
func (h *MasterHandler) CreateSuku(c *echo.Context) error {
	...
	item, err := h.service.CreateSuku(c.Request().Context(), &req, actor)
	if err != nil {
...
func (h *MasterHandler) UpdateSuku(c *echo.Context) error {
	...
	actor := he.BuildAuthContext(c)
	item, err := h.service.UpdateSuku(c.Request().Context(), id, &req, actor)
	if err != nil {
		return response.Response(c, http.StatusNotFound, false, err.Error(), nil, nil)
	}
...
func (h *MasterHandler) DeleteSuku(c *echo.Context) error {
	...
	actor := he.BuildAuthContext(c)
	err = h.service.DeleteSuku(c.Request().Context(), id, actor)
	if err != nil {
		return response.Response(c, http.StatusNotFound, false, err.Error(), nil, nil)
	}
