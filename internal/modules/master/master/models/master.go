...
// JenisKelamin
// ----------------------------------------------------------------------------------------
type MasterJenisKelamin struct {
	ID           int64          `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	Name         string         `gorm:"column:name;type:varchar(255);not null;index:idx_agama_name_active,unique,where:deleted_at IS NULL" json:"name"`
	KodeKemenkes *string        `gorm:"column:kode_kemenkes;type:varchar(50)" json:"kode_kemenkes"` // Mapping kode SatuSehat / SIRS
	Description  *string        `gorm:"column:description;type:text" json:"description"`
...
func (MasterJenisKelamin) TableName() string {
	return "master_jenis_kelamin"
} //---------------------------------------------------------------------------------------

// GolonganDarah
// ----------------------------------------------------------------------------------------
type MasterGolonganDarah struct {
	ID           int64          `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	Name         string         `gorm:"column:name;type:varchar(255);not null;index:idx_agama_name_active,unique,where:deleted_at IS NULL" json:"name"`
	KodeKemenkes *string        `gorm:"column:kode_kemenkes;type:varchar(50)" json:"kode_kemenkes"` // Mapping kode SatuSehat / SIRS
	Description  *string        `gorm:"column:description;type:text" json:"description"`
...
func (MasterGolonganDarah) TableName() string {
	return "master_golongan_darah"
} //---------------------------------------------------------------------------------------

// Suku
// ----------------------------------------------------------------------------------------
type MasterSuku struct {
	ID           int64          `gorm:"primaryKey;autoIncrement;column:id" json:"id"`
	Name         string         `gorm:"column:name;type:varchar(255);not null;index:idx_agama_name_active,unique,where:deleted_at IS NULL" json:"name"`
	KodeKemenkes *string        `gorm:"column:kode_kemenkes;type:varchar(50)" json:"kode_kemenkes"` // Mapping kode SatuSehat / SIRS
	Description  *string        `gorm:"column:description;type:text" json:"description"`
...
func (MasterSuku) TableName() string {
	return "master_suku"
} //---------------------------------------------------------------------------------------
