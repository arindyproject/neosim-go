...
func (s *MasterServiceTestSuite) SetupTest() {
	...
	s.svc = services.NewMasterService(s.repo, s.rbacRepo, s.authRepo)
}
...
func superadminActor() masterContracts.AuthContext {
	return masterContracts.AuthContext{UserID: 1, IsSuperadmin: true}
}

func regularActor() masterContracts.AuthContext {
	return masterContracts.AuthContext{UserID: 2, IsSuperadmin: false}
}
...
func (s *MasterServiceTestSuite) Test_Create_Superadmin_Success() {
	req := &dto.CreateMasterRequest{
		Name: "Test Master",
	}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.Master")).Return(nil)
...
func (s *MasterServiceTestSuite) Test_Create_WithPermission_Success() {
	req := &dto.CreateMasterRequest{
		Name: "Test Master",
	}
	actor := regularActor()
...
func (s *MasterServiceTestSuite) Test_Create_WithManagePermission_Success() {
	req := &dto.CreateMasterRequest{Name: "Test"}
	actor := regularActor()
...
func (s *MasterServiceTestSuite) Test_Create_Forbidden() {
	req := &dto.CreateMasterRequest{Name: "Test"}
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *MasterServiceTestSuite) Test_Create_RepoError() {
	req := &dto.CreateMasterRequest{Name: "Test"}
	actor := superadminActor()

	s.repo.On("Create", mock.AnythingOfType("*models.Master")).Return(fmt.Errorf("db error"))
...
func (s *MasterServiceTestSuite) Test_GetByID_Superadmin_Success() {
	actor := superadminActor()
	item := factories.NewMasterFactory().Make()
	item.ID = 1
...
func (s *MasterServiceTestSuite) Test_GetByID_WithPermission_Success() {
	actor := regularActor()
	item := factories.NewMasterFactory().Make()
	item.ID = 1
...
func (s *MasterServiceTestSuite) Test_GetByID_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *MasterServiceTestSuite) Test_GetByID_NotFound() {
	actor := superadminActor()
...
func (s *MasterServiceTestSuite) Test_GetByID_RepoError() {
	actor := superadminActor()
...
func (s *MasterServiceTestSuite) Test_List_Superadmin_Success() {
	actor := superadminActor()
	filter := &dto.FilterMasterRequest{}
	items := []models.Master{
		*factories.NewMasterFactory().Make(),
		*factories.NewMasterFactory().Make(),
	}
...
func (s *MasterServiceTestSuite) Test_List_WithPermission_Success() {
	actor := regularActor()
	filter := &dto.FilterMasterRequest{}
	items := []models.Master{*factories.NewMasterFactory().Make()}
...
func (s *MasterServiceTestSuite) Test_List_Forbidden() {
	actor := regularActor()
	filter := &dto.FilterMasterRequest{}
	s.mockNoPermissions()
...
func (s *MasterServiceTestSuite) Test_List_DefaultPagination() {
	actor := superadminActor()
	filter := &dto.FilterMasterRequest{}

	s.repo.On("List", 1, 10, filter).Return([]models.Master{}, int64(0), nil)
...
func (s *MasterServiceTestSuite) Test_List_PageSizeCapped() {
	actor := superadminActor()
	filter := &dto.FilterMasterRequest{}
...
func (s *MasterServiceTestSuite) Test_List_WithNameFilter() {
	actor := superadminActor()
	filter := &dto.FilterMasterRequest{Name: "test"}
	items := []models.Master{*factories.NewMasterFactory().Make()}
...
func (s *MasterServiceTestSuite) Test_Update_Superadmin_Success() {
	actor := superadminActor()
	existing := factories.NewMasterFactory().Make()
	existing.ID = 1
	newName := "Updated Name"
	req := &dto.UpdateMasterRequest{Name: &newName}

	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.AnythingOfType("*models.Master")).Return(nil)
...
func (s *MasterServiceTestSuite) Test_Update_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewMasterFactory().Make()
	existing.ID = 1
	newName := "Updated"
...
func (s *MasterServiceTestSuite) Test_Update_Forbidden() {
	actor := regularActor()
	req := &dto.UpdateMasterRequest{}
	s.mockNoPermissions()
...
func (s *MasterServiceTestSuite) Test_Update_NotFound() {
	actor := superadminActor()
	req := &dto.UpdateMasterRequest{}
...
func (s *MasterServiceTestSuite) Test_Update_PartialFields() {
	actor := superadminActor()
	existing := factories.NewMasterFactory().Make()
	existing.ID = 1
	...
	req := &dto.UpdateMasterRequest{Description: &newDesc}

	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.MatchedBy(func(m *models.Master) bool {
...
func (s *MasterServiceTestSuite) Test_Update_RepoError() {
	actor := superadminActor()
	existing := factories.NewMasterFactory().Make()
	existing.ID = 1
	req := &dto.UpdateMasterRequest{}
	...
	s.repo.On("GetByID", int64(1)).Return(existing, nil)
	s.repo.On("Update", mock.AnythingOfType("*models.Master")).Return(fmt.Errorf("db error"))
...
func (s *MasterServiceTestSuite) Test_Delete_Superadmin_Success() {
	actor := superadminActor()
	existing := factories.NewMasterFactory().Make()
	existing.ID = 1
...
func (s *MasterServiceTestSuite) Test_Delete_WithPermission_Success() {
	actor := regularActor()
	existing := factories.NewMasterFactory().Make()
	existing.ID = 1
...
func (s *MasterServiceTestSuite) Test_Delete_Forbidden() {
	actor := regularActor()
	s.mockNoPermissions()
...
func (s *MasterServiceTestSuite) Test_Delete_NotFound() {
	actor := superadminActor()
...
func (s *MasterServiceTestSuite) Test_Delete_RepoError() {
	actor := superadminActor()
	existing := factories.NewMasterFactory().Make()
	existing.ID = 1
